...
---
# Snippets 文件[[vless](https://github.com/ryty1/cf_snippet/blob/main/vless.js)] / [[shadowsocks](https://github.com/ryty1/cf_snippet/blob/main/shadowsocks.js)] / [[config-manager]([https://github.com/ryty1/cf_snippet/blob/main/config-manager.js](https://github.com/ryty1/cf_Snippets/blob/main/Config-Manager.js)] 配置说明
---
...
3. **修改 Clash转换 后端**
   ```javascript
   const SB = 'https://123.abc.com';  // 下面pages项目域名地址，不填默认内置老王的订阅转换，
   ```
