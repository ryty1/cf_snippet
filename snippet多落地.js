...
// --- 硬编码配置 ---
// UUID，同时用作订阅路径。
const authToken = 'e4d59882-dbac-426b-ae64-5abed091b6be';
// 用来访问cloudflare托管的网站
...
// 不启用socks配置为：const socks5Configs = [];
const socks5Configs = [
...
async function handleSocksCheck() {
    const results = [];

    for (const socksConfig of socks5Configs) {
